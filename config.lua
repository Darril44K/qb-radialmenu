                ...
                items = {
                    {
                        ...
                        id = 'houseLocations',
                        title = 'Lieux d\'interaction',
                        icon = 'home',
                        items = {
                            {
                                id = 'setstash',
                                title = 'Définir la réserve',
                                icon = 'box-open',
                                type = 'client',
    ...
    ["farmer"] = {
        {
            ...
            icon = 'shopping-cart',
            type = 'client',
            event = 'vdream-farmerjob:client:StartLiveryMission',
            shouldClose = true
        }
    },
    ["tsubakisushi"] = {
        {
            ...
            icon = 'file-invoice',
            type = 'client',
            event = 'vdream-command:client:openMenu',
            shouldClose = true
        },
        {
            id = 'delivery',
            title = 'Faire une livraison',
            icon = 'shopping-cart',
            type = 'client',
            event = 'vdream-tsubakisushi:client:StartDelivery',
            shouldClose = true
        },
        {
            id = 'delivery',
            title = 'Payement par carte',
            icon = 'shopping-cart',
            type = 'client',
            event = 'vdream-tsubakisushi:client:StartDelivery',
            shouldClose = true
